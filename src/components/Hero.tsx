...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/80 via-blue-800/70 to-teal-700/80 animate-gradient-move dark:from-gray-950/80 dark:via-gray-900/70 dark:to-gray-800/80" />
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/70 via-blue-800/60 to-teal-700/70 dark:from-gray-950/70 dark:via-gray-900/60 dark:to-gray-800/70" />
      {/* Tagline */}
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        <p className="text-base sm:text-lg text-cyan-200 font-semibold tracking-wide mb-2 dark:text-cyan-400">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 mb-10 max-w-3xl mx-auto leading-relaxed dark:text-gray-300">
        ...
        <p className="text-sm text-blue-200 mt-4 opacity-90 dark:text-blue-300">
