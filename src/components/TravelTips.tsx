        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {travelTips.map((tip, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`${bgColorClass} rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden`}
                >
                  ...
                  <div className="mt-4 text-xs text-blue-400 font-semibold uppercase tracking-wide">
                    Pro Tip
                  </div>
                </div>
              </div>
